  ...
  return (
    <div className="min-h-screen bg-[#fff0f5] px-4 py-10 text-[#4c1d95]">
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto grid min-h-[calc(100vh-80px)] w-full max-w-6xl overflow-hidden rounded-lg border border-[#f472b6]/18 bg-[#11100d]/92 shadow-2xl md:grid-cols-[1.05fr_.95fr]"
      >
        <div className="relative hidden min-h-full flex-col justify-end overflow-hidden p-12 md:flex">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#fff0f5] via-[#fff0f5]/78 to-transparent" />
          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleLogin} className="mt-8 space-y-5">
              ...
              <div className="flex justify-end">
                <button type="button" disabled={isSubmitting} onClick={handleForgotPassword} className="text-sm font-semibold text-[#db2777] transition hover:text-[#ffffff] disabled:opacity-60">Forgot Password?</button>
              </div>
            ...
            <button onClick={handleGoogleLogin} disabled={isSubmitting} className="mt-5 w-full rounded-md border border-[#f472b6]/35 bg-white px-4 py-3 font-semibold text-[#ffffff] transition hover:bg-[#fff3cd] disabled:opacity-60">
