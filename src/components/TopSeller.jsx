...
export const TopSeller = () => {
  ...
  return (
    <section id="top-sellers" className="scroll-mt-24 bg-ink px-4 py-16">
      <div className="mx-auto max-w-7xl">
        <p className="text-center text-xs font-semibold uppercase tracking-[0.32em] text-gold">Best of Haleel</p>
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 lg:gap-5">
          {isLoading ? (
            Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="mx-auto my-3 flex h-[520px] w-[95%] max-w-xs flex-col overflow-hidden rounded-lg border border-gold/10 bg-panel p-3 shadow-lg">
