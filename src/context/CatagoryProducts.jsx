...
export const CatagoryProducts = () => {
  ...
  if (loading) return <div className="min-h-screen bg-[#0b0a08]"><BrandLoader label="Finding your fragrance" /></div>;

  if (errorMessage) {
    return (
      <div className="flex h-screen flex-col items-center justify-center bg-[#0b0a08] px-6 text-center text-[#fff8e8]">
  ...
  if (!products?.length || filteredProducts.length === 0) {
    return (
      <>
        <Navbar />
        <div className="flex min-h-[70vh] flex-col items-center justify-center bg-[#0b0a08] px-6 text-center text-[#fff8e8]">
  ...
  return (
    <>
      <Navbar />
      <section className="min-h-screen bg-[#0b0a08] px-4 py-10 text-[#fff8e8]">
        <p className="text-xs font-semibold uppercase tracking-[0.32em] text-[#d7b46a]">Haleel Collection</p>
